...
function Home() {
  ...
  return (
    <>
      ...
      {/* <hr class="w-[100%] h-px my-0 bg-gray-200 border-[0px] border-black"></hr> */}
      ...
      <div className="Fluxograma xl:h-[90vh] 2xl:h-[90vh] w-full ">
        <div className="flex items-center">
          ...
          <hr class="w-[50%] h-px  bg-gray-200 border-[0.5px] border-black"></hr>
        </div>
      ...
      <hr class="w-[100%] h-px my-5 bg-gray-200 border-[0px] border-black"></hr>
      ...
      <div className="xl:w-full flex justify-center">
        <div className="xl:w-[90%] h-[60vh] justify-center flex flex-col">
          <div className="h-[30%]">
            <h1 className="xl:text-[5vh]">Entre em contato conosco</h1>
          </div>
          <div className="fotos xl:w-full justify-evenly flex">
            <Foto
              nome_area={"Lucas Capovila"}
              area={"CaP/ETS"}
              foto={"bg-capovila"}
            />
            <Foto
              nome_area={"Luiza Moraes"}
              area={"CaP/ETS"}
              foto={"bg-luiza"}
            />
            <Foto
              nome_area={"Michael Douglas"}
              area={"CaP/ETS"}
              foto={"bg-michael"}
            />
            <Foto
              nome_area={"Naely Pereira"}
              area={"CaP/ETS"}
              foto={"bg-naely"}
            />
          </div>
      ...
      <hr class="w-[100%] h-px my-1 bg-gray-200 border-[0px] border-black"></hr>
      <Footer />
    </>
  );
}
