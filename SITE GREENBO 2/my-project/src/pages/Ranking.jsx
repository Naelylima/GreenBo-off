      ...
      <div className="items-center content-center">
        ...
        <div className="grid ml-[10vh] mr-[10vh] ">
          ...
          <div className="flex justify-between items-end ">
            <div className="w-[45%] rounded-[15px] border-[#DADADA] shadow-md shadow-[#A8A6A6] border ">
              <GraficoRanking />
            </div>
            <div className="w-[40%] flex items-end content-end justify-between 2xl:w-[36%]">
              <ChartColumn
                h={"xl:h-[48vh] 2xl:h-[45vh]"}
                bg={"bg-[#007BC0]"}
                posicao={"2nd"}
                empresa={"PS"}
                porcentagem={"18,4"}
